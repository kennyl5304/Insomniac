...
public class DoorController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (playerInZone)
        {
            ...
            {
                txtToDisplay.GetComponent<TMP_Text>().text = "Press 'A' to Close";
                doorCollider.enabled = false;
            }
            else if (doorState == DoorState.Closed || gotKey)
            {
                txtToDisplay.GetComponent<TMP_Text>().text = "Press 'A' to Open";
        ...
        if (OVRInput.Get(OVRInput.Button.One) && playerInZone)
        {
